...
import com.mjimenez.app_android.fragment.CanguroFragment.OnListFragmentInteractionListener;
...
public class CanguroAdapter extends RecyclerView.Adapter<CanguroAdapter.ViewHolder> {
    ...
    public CanguroAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
