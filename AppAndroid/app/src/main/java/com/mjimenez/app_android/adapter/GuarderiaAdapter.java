...
import com.mjimenez.app_android.fragment.GuarderiaFragment.OnListFragmentInteractionListener;
...
public class GuarderiaAdapter extends RecyclerView.Adapter<GuarderiaAdapter.ViewHolder> {
    ...
    public GuarderiaAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
